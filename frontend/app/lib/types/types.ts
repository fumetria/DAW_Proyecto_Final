import { articlesTable, categoriesTable, numsReceiptsTable, receiptsLineTable, receiptsTable, usersTable, paymentMethodsTable, taxesTable } from "@/app/db/schema";
...
export type tax = InferSelectModel<typeof taxesTable>;
