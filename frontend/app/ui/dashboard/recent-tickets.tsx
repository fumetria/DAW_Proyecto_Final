...
// Defining type inline based on schema, or import if available. 
// For now, defining strict subset needed.
type Receipt = {
    id: string;
    num_receipt: string;
    total: number;
    ...
    limit?: number; // Not real prop, just matching any potential extra props
};
        ...
        <div className="flex w-full flex-col md:col-span-4">
            ...
            <div className="flex grow flex-col justify-between rounded-xl bg-gray-50 p-4 dark:bg-slate-800">
                                ...
                                <div className="flex items-center">
                                    <div className="flex items-center gap-3">
                                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 dark:bg-slate-700">
                                            <FontAwesomeIcon icon={faReceipt} className="h-4 w-4 text-gray-500 dark:text-gray-300" />
                                        </div>
                ...
                <div className="flex items-center pb-2 pt-6">
                    <FontAwesomeIcon icon={faArrowsRotate} className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                    <h3 className="ml-2 text-sm text-gray-500 dark:text-gray-400 ">Actualizado ahora</h3>
                </div>
            </div>
        </div>
    );
