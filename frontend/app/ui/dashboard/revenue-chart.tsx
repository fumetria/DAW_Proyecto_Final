    ...
    return (
        <div className="w-full md:col-span-4">
            ...
            <div className="rounded-xl bg-gray-50 p-4 shadow-sm dark:bg-slate-800">
                <div className="sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-white p-4 dark:bg-slate-900 md:gap-4">
                ...
                <div className="flex items-center pb-2 pt-6">
                    <FontAwesomeIcon icon={faCalendar} className="h-5 w-5 text-gray-500 dark:text-gray-400" />
