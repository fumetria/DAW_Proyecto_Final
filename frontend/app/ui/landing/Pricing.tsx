      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-stone-600 dark:text-slate-300">
            Elige el plan que mejor se adapte a tu etapa actual. Sin costes
            ocultos.
          </p>
        </div>
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <div className="mb-8 flex items-baseline gap-1">
                ...
                {tier.price !== "A medida" && (
                  <span className="text-sm font-semibold text-stone-500 dark:text-slate-400">
                    /mes
                  </span>
                )}
              </div>
              ...
              <ul
                role="list"
                className="mb-8 space-y-3 text-sm leading-6 text-stone-600 dark:text-slate-300"
              >
              ...
              <div className="mt-auto">
                <Link
                  href={tier.price === "A medida" ? "#contact" : "#contact"}
                  className={`block w-full rounded-full px-3 py-3 text-center text-sm font-semibold leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all ${
                    tier.mostPopular
