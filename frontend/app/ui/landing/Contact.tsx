          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-stone-600 dark:text-slate-300 mb-8">
                Estamos aquí para ayudar a que tu empresa crezca. Escríbenos y te responderemos en menos de 24h.
              </p>
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-stone-700 dark:text-slate-300 mb-1">Nombre</label>
                <input
                  type="text"
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-stone-700 dark:text-slate-300 mb-1">Email</label>
                <input
                  type="email"
                  id="email"
                  className="w-full rounded-xl border border-stone-200 dark:border-slate-600 bg-white dark:bg-slate-700/50 px-4 py-3 text-stone-900 dark:text-slate-100 placeholder-stone-400 focus:border-blue-500 focus:ring-blue-500 focus:outline-none transition-colors"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-stone-700 dark:text-slate-300 mb-1">Mensaje</label>
                <textarea
                  id="message"
                  rows={4}
                  className="w-full rounded-xl border border-stone-200 dark:border-slate-600 bg-white dark:bg-slate-700/50 px-4 py-3 text-stone-900 dark:text-slate-100 placeholder-stone-400 focus:border-blue-500 focus:ring-blue-500 focus:outline-none transition-colors"
