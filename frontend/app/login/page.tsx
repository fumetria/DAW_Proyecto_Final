    ...
    <>
      <main>
        <div className="grid grid-cols-6 w-screen h-screen">
          ...
          <div className="bg-stone-200 col-span-2 grid justify-items-center items-center ">
            <form action="" className="bg-stone-100 rounded p-8 shadow">
              <div className="mb-4">
                <svg
              ...
              <div className="my-1 grid">
                ...
                <div className="text-base flex border-2 rounded py-1 ps-1 gap-2 focus-within:border-2 focus-within:border-blue-400">
                  <FontAwesomeIcon
                    icon={faUser}
